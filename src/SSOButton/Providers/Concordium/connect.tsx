          ...
          <Col lg={`${noLogin ? '6' : '12'}`}>
            {isDesktop ? (
              <button
                ...
                type="button"
                className={`btn btn-dark btn-concordium fw-medium text-nowrap py-2 px-4 fs-18 lh-sm text-white d-flex align-items-center justify-content-start w-100 rounded-pill ${
